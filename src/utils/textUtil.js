export const textHome = {
  ...
  home_big_text: 'Stories are always told better in motion. Jump on board and book your first video',
}

export const social = {
  instagram: 'https://www.instagram.com/mikelunc/',
  facebook: 'https://www.facebook.com/MikeLuncProduction/',
  twitter: 'https://twitter.com/MikeLunc',
}
...
export const textServices = {
  about_small_text: 'What we can offer?',
  about_big_text: 'Build your online presence',
}
...
export const textContact = {
  ...
  email: 'Email: mihailuncan13@gmail.com',
}
